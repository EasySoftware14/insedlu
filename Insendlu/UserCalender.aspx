<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UserCalender.aspx.cs" Inherits="Insendlu.UserCalender" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row">
            <h1 class="">Task Calender</h1>
            <hr />
            <div class="col-md-12">
                <asp:Calendar ID="userCalender" runat="server" BackColor="#FFFFCC" BorderColor="#FFCC66" BorderWidth="1px" OnSelectionChanged="bcc_OnSelectionChanged" DayNameFormat="Full" Font-Names="Verdana" Font-Size="8pt" ForeColor="#663399" Height="250px" OnDayRender="bcc_OnDayRender" ShowGridLines="True" ToolTip="Project Time-Line" TitleFormat="Month" Width="1089px">
