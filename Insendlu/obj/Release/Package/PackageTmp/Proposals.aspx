<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Proposals.aspx.cs" Inherits="Insendlu.Proposals" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row">
            <br />
            <h1 class="label-light">Proposals Log Book</h1>
            <hr />
            <div class="col-lg-3">
            ...
            <div class="col-lg-3">
                <asp:Button runat="server" ID="submitted" OnClick="submitted_OnClick" Text="Pending Proposals" CssClass="btn btn-sm btn-default" />

            </div>
           
            <div class="col-lg-3">
                <asp:Button runat="server" ID="pending" OnClick="pending_OnClick" Text="Secured Proposals" CssClass="btn btn-sm btn-pink" />

            </div>
            <div class="col-lg-3">
                <asp:Button runat="server" ID="declined" OnClick="declined_OnClick" Text="Declined Proposals" CssClass="btn btn-sm btn-danger" />
        ...
        <div class="row">
            <div class="col-lg-11">
                ...
                <asp:GridView runat="server" Visible="False" ID="datagridview" CssClass="table table-bordered table-hover" AllowPaging="True"
                    ...
                    OnPageIndexChanged="datagridview_OnPageIndexChanged"
